...
export default function AdminTransfers() {
  ...
  const finalizeOnChain = async (transfer) => {
    ...
    if (!land?.[0] || land[0].toLowerCase() === '0x0000000000000000000000000000000000000000') {
      throw new Error(`Parcel "${parcelId}" is not registered on the current contract. This is a legacy database transfer; create a new transfer after registering the property on this contract.`);
    }
